...
public class Problema_5_2 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		...
		imprimir("Empleados con sueldos mayor al promedio\t: " + as.cantMayoresSueldoPromedio());
		imprimir("Empleados con sueldos menor al promedio\t: " + as.cantMenoresSueldoPromedio());
		imprimir("Posición del 2do sueldo mayor a 850\t: " + as.posSegundoSueldoMayorAlMinimo());
		imprimir("Posición del último sueldo menor a 850\t: " + as.posUltimoSueldoMenorAlMinimo());
	}
	protected void actionPerformedBtnGenerar(ActionEvent arg0) {
		// Generar sueldos en el arreglo
		as.generarSueldos();
		imprimir("");
		imprimir("Se han generado los sueldos. click en [Listar]");
	}
