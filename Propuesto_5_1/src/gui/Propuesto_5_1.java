...
public class Propuesto_5_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		...
		imprimir("Notas aprobatorias\t\t: " + an.cantNotasAprobatorias());
		imprimir("Notas desaprobatorias\t\t: " + an.cantNotasDesaprobatorias());
		imprimir("Notas mayores a 15\t\t: " + an.cantNotasMayoresA15());
		imprimir("Posición Primera nota mayor a 13\t: " + an.posPrimeraNotaAprobatoria());
		imprimir("Posición Penúltima nota menor a 13\t: " + an.posPenultimaNotaDesaprobatoria());
	}
	protected void actionPerformedBtnGenerar(ActionEvent arg0) {
		an.generarNotas();
		imprimir();
		imprimir("Las notas han sido cambiadas. Click en [Listar]");
